...
subtitle: "Visualization & Pattern Analysis (1950–2022)"
execute:
  echo: false
  warning: false
---
...
<span style="background:#1f1f1f;color:#b3b3b3;font-size:0.68rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:0.3rem 0.75rem;border-radius:3px;border:1px solid #333;">ggplot2</span>
...
<span style="background:#1f1f1f;color:#b3b3b3;font-size:0.68rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:0.3rem 0.75rem;border-radius:3px;border:1px solid #333;">WHO Data</span>
</div>
```
...
# Load the data
data <- suicide_data <- read.csv("suicide-rates-by-age.csv")
...
The complete source code for all visualizations on this page.
...
# Load the data
data <- read.csv("suicide-rates-by-age.csv")
