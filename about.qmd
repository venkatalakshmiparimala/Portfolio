...
### ![](images/Screenshot%202025-01-15%20194855.png){width="250"}
...
##### **Software Engineer,** Entrata India (Db Xento Systems) – Pune, India    **Oct 2018 – Aug 2024**
...
##### **PPA Assistant – Event ManagementGeorge Mason University, University Life – Mason Square (Mar 2025 – Present)**
...
-   **•	Frameworks/Tools**: PyTorch, Scikit-learn, TensorFlow, Docker, REST APIs, Git, JIRA, Spark, Hive, Tableau, Power BI\
...
-   **Machine Learning**: Recommendation Systems, NLP (LLMs, embeddings), Clustering, Classification.
...
#### **CrashClarity: UK Road Accidents Analysis**
#### **Tools: R, Random Forest, Logistic Regression, GitHub Pages**   
#### **https://venkatalakshmiparimala.github.io/Portfolio/project_details.html**
...
#### **Tools: Python, XGBoost, Random Forest, PyTorch, Scikit-learn, Docker, Tableau**
#### **https://mason.gmu.edu/~vpasupu2/index.html** 

- 	Implemented XGBoost and Random Forest to explore effects of crime, education, and healthcare access
...
#### **Technologies: Python, Scikit-learn, KNN, Collaborative Filtering, Power BI**
...
#### **Technologies: Python, Pandas, Scikit-learn, PCA, Linear Regression**
